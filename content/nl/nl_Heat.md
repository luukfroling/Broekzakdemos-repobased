...
Je hebt twee halve glazen water elk op de omgevingstemperatuur. Nu giet je ze bij elkaar, de temperatuur wordt dan 20 $^{\circ}$C, 40 $^{\circ}$C, of iets minder dan 40 $^{\circ}$C? Er zijn leerlingen die kiezen voor die 40 $^{\circ}$C en die temperaturen optellen. Misschien toch even goed om die leerlingen te confronteren. Als temperaturen optelbaar waren, dan zou je water kunnen koken door 5 glazen van 20 $^{\circ}$C bij elkaar te doen. Koken zonder energie! Deze demo kan ook een startpunt zijn voor discussie van intensieve en extensieve grootheden.

%Ik heb 5 gazen water van de kraan, allemaal met een temperatuur van 20 $^{\circ}$C. Als ik ze bij elkaar giet, wat is dan de temperatuur? A. 20 $^{\circ}$C,
%B. 40 $^{\circ}$C, of  
...
```{figure} ../images/20250513_111649.*
:width: 50%
:name: fig_stroming

De stroming van lucht boven de kaars kun je eenvoudig zichtbaar maken met de zaklamp van je telefoon
```
