\documentclass[a4paper,16pt,oneside]{book} %You can change the paper size and font size here. The default is A4 and 11pt.
...
% \title{%
%  \Huge \textbf{Project Title Goes Here} \\  % Title in large, bold font
%  \vspace{0.5em}
%  \huge \textit{Optional Subtitle Goes Here}  % Subtitle in italic, smaller font
% }

% Author setup: Author(s) of the document
% \author{Freek Pols}
